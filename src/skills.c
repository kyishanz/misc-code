...
//    turnRoller(0, 2000);
    ...
    brake(-10);
    // shooting 1st batch of 3

//    skillsGPSAim(blueGoalX, blueGOALY, true, false);
...
//    turnRight(-1400, 50);
    ...
    startIntake(0);
    delay(400);
//    forwardCoastHeading(convertInchesToTicks(1), 40, 900);

//    assignDriveMotorsVoltage(40);
//    delay(30);
//    turnRollerByTimeProgrammingSkills(240);
//    turnRoller(0, 2000);
    turnRollerByTimeProgrammingSkills(400);
...
//    forwardCoastHeading(convertInchesToTicks(18), 40, 1350);
    turnRight(900, 50);
    ...
    delay(200);
//    forwardCoastHeading(convertInchesToTicks(6), 40, 400);

    turnLeft(710, 127);
//    skillsGPSAim(blueGoalX, blueGOALY, false, false, 3);
////    delay(200);
//    skillsGPSAim(blueGoalX, blueGOALY, false, false, 3);
    delay(100);
    ...
    turnRight(1800, 50);
    startIntake(0);
    backwardCoastHeading(convertInchesToTicks(2), 40, 1800);
    turnRoller(0);
    delay(100);
    startIntake(127);
    forwardCoastHeading(convertInchesToTicks(5), 40, 1800);
//    forwardCoastHeading(convertInchesToTicks(6), 40, 1300);
    turnRight(450, 50);
    backwardCoastHeading(convertInchesToTicks(19), 40, 450);
//    delay(300);
    startIntake(0);
    backwardCoastHeading(convertInchesToTicks(2), 50, 900);
//    turnRight(90, 50);
    turnRoller(0);
     */
